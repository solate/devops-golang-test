...
//+kubebuilder:webhook:path=/mutate-apps-example-com-v1-mystatefulset,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.example.com,resources=mystatefulsets,verbs=create;update,versions=v1,name=mmystatefulset.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-apps-example-com-v1-mystatefulset,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.example.com,resources=mystatefulsets,verbs=create;update,versions=v1,name=vmystatefulset.kb.io,admissionReviewVersions=v1
